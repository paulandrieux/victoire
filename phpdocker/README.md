...
You can access your application via **`localhost`**, if you're running the containers directly, or through **`192.168.33.91`** when run on a vm. nginx and mailhog both respond to any hostname, in case you want to add your own hostname on your `/etc/hosts` 

Service|Address outside containers|Address outside VM
------|---------|-----------
Webserver|[localhost:8000](http://localhost:8000)|[192.168.33.91](http://192.168.33.91)
Mailhog web interface|[localhost:8001](http://localhost:8001)|[192.168.33.91:81](http://192.168.33.91:81)
